...
var x{0..pathlength} : integer;
\end{lstlisting}%
The transformation from a sequence of \UMLType{ControlFlow}s and \UMLType{Action}s into an activation set is given in Algoritm \ref{alg:ActivationSet}.
\begin{algorithm}
\begin{algorithmic}[1]
