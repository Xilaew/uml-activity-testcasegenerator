...
import net.sf.parteg.base.testcasegraph.systemstate.SystemModelState;
...
//				}
	...
	public static Namespace getNamespaceForEvent(
			Vertex in_oVertex, 
			Event in_oEvent,
...
//				}
	...
	public static boolean twoOperationsHaveTheSameParameters(
			Operation in_oOperation1,
			Operation in_oOperation2) {
		// size unequal
		if(in_oOperation1.getOwnedParameters().size() != in_oOperation2.getOwnedParameters().size()) {
			return false;
		}
