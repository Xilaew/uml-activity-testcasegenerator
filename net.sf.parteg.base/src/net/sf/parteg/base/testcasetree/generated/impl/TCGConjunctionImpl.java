 ...
 * <ul>
 *   <li>{@link net.sf.parteg.base.testcasetree.generated.impl.TCGConjunctionImpl#getExpressions <em>Expressions</em>}</li>
 *   <li>{@link net.sf.parteg.base.testcasetree.generated.impl.TCGConjunctionImpl#isCanChangeValueIfOneExpressionChanges <em>Can Change Value If One Expression Changes</em>}</li>
 *   <li>{@link net.sf.parteg.base.testcasetree.generated.impl.TCGConjunctionImpl#isPositiveSubExpressionOfOriginal <em>Positive Sub Expression Of Original</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TCGConjunctionImpl extends EObjectImpl implements TCGConjunction {
	...
	public EList<TCGOCLExpression> getExpressions() {
		if (expressions == null) {
			expressions = new EObjectContainmentEList<TCGOCLExpression>(TCGOCLExpression.class, this, GeneratedPackage.TCG_CONJUNCTION__EXPRESSIONS);
		}
		return expressions;
	}
