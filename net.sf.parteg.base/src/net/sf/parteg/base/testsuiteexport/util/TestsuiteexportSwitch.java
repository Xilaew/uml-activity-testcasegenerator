 ...
 * @generated
 */
public class TestsuiteexportSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TestsuiteexportPackage.TS: {
				TS ts = (TS)theEObject;
				T result = caseTS(ts);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestsuiteexportPackage.TC: {
				TC tc = (TC)theEObject;
				T result = caseTC(tc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestsuiteexportPackage.VARIABLE: {
				Variable variable = (Variable)theEObject;
				T result = caseVariable(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestsuiteexportPackage.CALL: {
			...
			case TestsuiteexportPackage.CHECK: {
			...
			case TestsuiteexportPackage.ACTION: {
				Action action = (Action)theEObject;
				T result = caseAction(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestsuiteexportPackage.EXP: {
				Exp exp = (Exp)theEObject;
				T result = caseExp(exp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestsuiteexportPackage.ATOM: {
				Atom atom = (Atom)theEObject;
				T result = caseAtom(atom);
				if (result == null) result = caseExp(atom);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestsuiteexportPackage.COMPLEX: {
				Complex complex = (Complex)theEObject;
				T result = caseComplex(complex);
				if (result == null) result = caseExp(complex);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
