...
The generated tests will satisfy control flow--based coverage criteria on the used models. Since unit tests using test data at the bounds of path constraints do have a higher probability to detect faults, we also use boundary value analysis for testing. A special focus is on allowing mixed integer non--linear programming as well as logical formulas in OCL constraints, since we want to put as little restrictions as possible on the used test models.}
\pagenumbering{Roman}
\tableofcontents
\clearpage
