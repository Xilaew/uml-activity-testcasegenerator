...
% As the technology for finding suitable test cases \cite{Patel12TestCaseFormationUsigUMLActivityDiagram}, \cite{kundu2009novel}, \cite{Linzhang04GeneratingTestCasefromActivityGrayBoxMethod} and \cite{Offutt:1999:GeneratingTestsFromUmlSpec} propose mainly some kind of graph search.
