...
\end{tikzpicture}%
%\end{center}
\caption{Runtime of our algorithm applied to the case study. We measured the runtime with different solvers and varied maximum path length. The runtime as well as the number of test cases grow exponentially with the maximum path length.}
...
xmax=15,
%ytick={1e8,1e10,1e12,1e14},
yticklabels={{0.1},{1},{10},{100},{$10^3$},{10^4},{$10^5$}},
%ytick={10000000000,60000000000,600000000000,3600000000000,864e11},
%yticklabels={10s,1m,10m,1h,1d},
ymajorgrids=true,
yminorgrids=true,
...
\addplot[solid,mark=x] table[x=PathsFound,y=time(ns)]{Experiment-DATA/CaseStudyRuntimeNoBoundaryValues.csv};
...
\end{axis}
\end{tikzpicture}%
\caption{Runtime of depending on the number of test cases.}
