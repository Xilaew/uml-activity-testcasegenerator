...
/**
 * This is the item provider adapter for a {@link org.xilaew.atg.model.tests.SUT} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SUTItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SUT_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SUT_name_feature", "_UI_SUT_type"),
				 TestsPackage.Literals.SUT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addObjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SUT_object_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SUT_object_feature", "_UI_SUT_type"),
				 TestsPackage.Literals.SUT__OBJECT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((SUT)object).getName();
