 ...
 * @generated
 */
public class Package1Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Package1Package.CLASS1: {
				class1 class1 = (class1)theEObject;
				T result = caseclass1(class1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Package1Package.TYPE1: {
				type1 type1 = (type1)theEObject;
				T result = casetype1(type1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Package1Package.CLASS1_TEST_ACTIVITY: {
				class1_testActivity class1_testActivity = (class1_testActivity)theEObject;
				T result = caseclass1_testActivity(class1_testActivity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Package1Package.CLASS2: {
			...
			case Package1Package.TYPE2: {
				type2 type2 = (type2)theEObject;
				T result = casetype2(type2);
				if (result == null) result = casetype1(type2);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T casetype1(type1 object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>class1 test Activity</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>class1 test Activity</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseclass1_testActivity(class1_testActivity object) {
		return null;
	}
