...
public class FunctionCallImpl extends MinimalEObjectImpl.Container implements FunctionCall {
	...
	protected EClass eStaticClass() {
		return TestsPackage.Literals.FUNCTION_CALL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestsPackage.FUNCTION_CALL__NAME, oldName, name));
	}
	...
	public EList<Value> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Value>(Value.class, this, TestsPackage.FUNCTION_CALL__PARAMETERS);
		}
		return parameters;
	}
